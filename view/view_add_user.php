                            ...
                            <div class="card-body p-5">
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <a href="../user/show_all_user.php"><button type="submit" 
                                            class="btn btn-success btn-block btn-lg gradient-custom-4 text-body" name="submit" >Register</button></a>
                                    </div>

                                    <p class="text-center text-muted mt-5 mb-0">Have already an account? <a href="../view/view_login.php" class="fw-bold text-body"><u>Login here</u></a></p>
